 ...
 * 1.00       19 May 2021     Doug Humberd     Gets all files attached to a Purchase Order, and attaches to / sends the PO Approved emails
 *
 */
 ...
 */
function is_send_Approval_Email(){
	...
	try{
		...
		var emailSubj = 'Purchase Order ' + poTranId + ' has been Approved';
